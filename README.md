...
module "postgresql-db" {
  source               = "https://github.com/opsstation/terraform-gcp-postgresql.git"
  name                 = "test"
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/opsstation/terraform-gcp-postgresql/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/opsstation/terraform-gcp-postgresql/blob/master/LICENSE) file for details.
